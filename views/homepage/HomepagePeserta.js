            ...
            <div className="max-w-7xl mx-auto px-4 md:px-0">
                ...
                <section id="gallery" className="w-full flex flex-col items-center pb-14">
                    <div className="relative w-full max-w-6xl mx-auto flex items-center justify-center mb-12">
                        <div
                            onClick={prev}
                            className="absolute left-0 z-20 bg-white text-teal-800 rounded-full w-10 h-10 flex items-center justify-center shadow transition-colors"
                        >
                            <ChevronLeft />
                        </div>
                        ...
                        <div
                            onClick={next}
                            className="absolute right-0 z-20 bg-white text-teal-800 rounded-full w-10 h-10 flex items-center justify-center shadow transition-colors"
                        >
                            <ChevronRight />
                        </div>
                    </div>
                ...
                <div className="w-full px-4 md:px-6 py-6 md:py-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-7 gap-3 pb-10 md:gap-4 items-center justify-items-center">
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/logolombasma.png"
                                    alt="Lomba SMA"
                                    fill
                                    className="object-contain p-2"
                                    draggable={false}
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/eventpelajar.jpg"
                                    alt="Event Pelajar"
                                    fill
                                    className="object-contain p-2"
                                    draggable={false}
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/infolomba.png"
                                    alt="Info Lomba"
                                    fill
                                    className="object-contain p-2"
                                    draggable={false}
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/pointkampus.png"
                                    alt="Point Kampus"
                                    fill
                                    className="object-contain p-2"
                                    draggable={false}
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/katalogevent.png"
                            ...
                            <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                                <Image
                                    src="/Asset/medpar/partnerevent.png"
                                    alt="Partner Event"
                                    fill
                                    className="object-contain p-2"
                                    draggable={false}
