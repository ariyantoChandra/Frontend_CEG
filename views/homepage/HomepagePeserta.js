  ...
  return (
    <div className="relative w-full min-h-screen overflow-y-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-0">
          ...
          <div className="flex flex-col items-center text-center max-w-5xl">
            ...
            <div className="bg-white/30 backdrop-blur-sm border border-white/40 rounded-[30px] p-6 md:p-8 shadow-2xl mb-8">
              <p className="text-sm md:text-lg font-medium leading-relaxed text-teal-950 text-justify md:text-center">
                Chemical Engineering Games atau CEG merupakan lomba tahunan yang
                diselenggarakan oleh Program Studi Teknik Kimia Universitas
                Surabaya dan ditujukan bagi siswa/i SMA/sederajat dari seluruh
                Indonesia. Kegiatan ini dikemas dalam bentuk rangkaian games
                yang seru, edukatif, dan unik, sehingga peserta tidak hanya
                ditantang secara kompetitif, tetapi juga diajak untuk berpikir
          ...
          <div className="relative w-full max-w-6xl mx-auto flex items-center justify-center mb-12">
            ...
            <div className="flex items-center justify-center gap-6 overflow-hidden w-full">
              {visibleImages.map(({ idx, src, isActive }) => (
                <div
                  key={idx}
                  className={`relative transition-[transform,opacity] duration-300 will-change-transform ${
                    isMobile
            ...
            <div className="md:col-span-8 flex flex-col items-start">
              ...
              <div className="bg-white/40 backdrop-blur-sm rounded-[25px] p-6 md:p-8 shadow-lg w-full border border-white/20">
                ...
                <p className="text-teal-950 font-bold mb-4 text-sm md:text-base uppercase italic">
                  AGRINOVA: Agricultural Innovation for Sustainable Nutrition
                  Advancement
                </p>
                <p className="text-teal-950 font-medium text-sm md:text-base leading-relaxed text-justify">
                  AGRINOVA menggambarkan sebuah ledakan inovasi yang lahir dari
                  dunia pertanian sebagai respons terhadap tantangan pangan masa
                  kini dan masa depan. Kata “Nova” berarti bintang baru, yang
                  menjadi simbol munculnya gagasan, pendekatan, dan terobosan
                  baru dalam menciptakan sistem pangan yang lebih sehat,
                  efisien, dan ramah lingkungan. Melalui konsep ini, AGRINOVA
                  merepresentasikan semangat pembaruan dan kreativitas dalam
                  mengembangkan pertanian modern yang tidak hanya berorientasi
                  pada hasil, tetapi juga pada keberlanjutan dan kualitas.
                  AGRINOVA merupakan langkah transformasi dari pertanian
                  tradisional menuju sistem pangan masa depan yang berbasis pada
                  sains, teknologi, dan prinsip keberlanjutan, guna mendukung
                  ketahanan pangan serta kesejahteraan generasi mendatang.
                </p>
              </div>
            </div>
        ...
        <section
          id="pre-event"
          className="w-full flex flex-col items-center pt-20 md:pt-24"
        >
          <div>
            <Image
          ...
          <div className="flex flex-col md:flex-row gap-6 my-8 z-10 px-4 w-full justify-center">
            <div className="bg-white/40 backdrop-blur-md border border-white/50 p-6 rounded-2xl text-center shadow-lg transform hover:scale-105 transition-transform w-full md:w-64">
              <h3 className="text-teal-900 font-bold text-xl mb-1">
                EARLY BIRD
              </h3>
            ...
            <div className="bg-teal-900/10 backdrop-blur-md border border-teal-900/20 p-6 rounded-2xl text-center shadow-lg transform hover:scale-105 transition-transform w-full md:w-64">
              ...
              <p className="text-teal-800 text-sm mb-3">
                23 Januari - 21 Februari 2026
              </p>
              <p className="text-3xl font-black text-teal-900">Rp 170.000</p>
              <p className="text-teal-900/60 text-xs mt-2">Per Tim</p>
            </div>
            <div className="bg-teal-900/10 backdrop-blur-md border border-teal-900/20 p-6 rounded-2xl text-center shadow-lg transform overflow-hidden hover:scale-105 transition-transform w-full md:w-64">
              <div className="absolute top-0 right-0 bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded-bl-lg">
                LIMITED
              </div>
              <h3 className="text-teal-900 font-bold text-xl mb-1">EXTEND</h3>
              <p className="text-teal-800 text-sm mb-3">
                22 Februari - 3 Maret 2026
              </p>
              <p className="text-3xl font-black text-teal-900">Rp 170.000</p>
              <p className="text-teal-900/60 text-xs mt-2">Per Tim</p>
            </div>
            <div className="bg-gradient-to-b from-yellow-300/40 to-yellow-500/40 backdrop-blur-md border border-yellow-400 p-6 rounded-2xl text-center shadow-xl transform hover:scale-105 transition-transform relative overflow-hidden w-full md:w-64">
              ...
              <p className="text-teal-800 text-sm mb-3">Extend</p>
              <p className="text-3xl font-black text-[#d64040]">Rp 495.000</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl">
            <div className="bg-white/40 backdrop-blur-sm border border-white/60 rounded-[40px] p-8 shadow-2xl flex flex-col items-center group">
              ...
              <p className="text-teal-900/60 text-sm mb-8 text-center leading-relaxed">
                Informasi mendalam mengenai pendaftaran dan aturan.
              </p>
              <Button
                asChild
            ...
            <div className="bg-white/40 backdrop-blur-sm border border-white/60 rounded-[40px] p-8 shadow-2xl flex flex-col items-center group">
              ...
              <p className="text-teal-900/60 text-sm mb-8 text-center leading-relaxed">
                Panduan operasional selama hari-H kompetisi.
              </p>
              <Button
                asChild
          ...
          <div className="grid gap-4 w-full">
            {faqData.map((item) => (
              <div key={item.id} className="group">
                <h3 className="text-teal-900 font-black text-sm md:text-xl ml-4 mb-2">
                ...
                <div className="bg-white/40 backdrop-blur-sm border border-white/40 rounded-[20px] px-6 py-4 shadow-sm group-hover:bg-white/60 transition-colors duration-200">
                  <p className="text-teal-950 font-medium text-xs md:text-base leading-relaxed">
                    {item.answer}
                  </p>
                </div>
              </div>
      ...
      <footer
        id="CP&Partner"
        className="relative w-full mt-24 bg-white/20 backdrop-blur-md border-t border-white/30"
      >
        <div className="w-full px-4 md:px-6 py-6 md:py-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-7 gap-3 pb-10 md:gap-4 items-center justify-items-center">
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/logolombasma.webp"
                  alt="Lomba SMA"
                  fill
                  className="object-contain p-2"
                  draggable={false}
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/eventpelajar.webp"
                  alt="Event Pelajar"
                  fill
                  className="object-contain p-2"
                  draggable={false}
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/infolomba.webp"
                  alt="Info Lomba"
                  fill
                  className="object-contain p-2"
                  draggable={false}
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/pointkampus.webp"
                  alt="Point Kampus"
                  fill
                  className="object-contain p-2"
                  draggable={false}
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/katalogevent.webp"
                  alt="Katalog Event Indonesia"
                  fill
                  className="object-contain p-2"
                  draggable={false}
                  loading="lazy"
              ...
              <div className="relative w-full aspect-square max-w-24 md:max-w-32 bg-white/40 backdrop-blur-sm rounded-lg p-3 border border-white/40 flex items-center justify-center hover:bg-white/60 transition-colors">
                <Image
                  src="/Asset/medpar/partnerevent.webp"
                  alt="Partner Event"
                  fill
                  className="object-contain p-2"
                  draggable={false}
