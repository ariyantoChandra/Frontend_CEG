  ...
  return (
    <div className="min-h-screen relative w-full font-sans">
      ...
      <div className="container mx-auto px-4 pt-32 flex justify-center pb-20">
        {loading ? (
          <div className="bg-white/50 backdrop-blur-md p-8 rounded-3xl flex flex-col items-center shadow-xl">
            ...
            <CardContent className="p-6 md:p-8 space-y-8">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                {data.status_pembayaran === "LUNAS" || data.status_pembayaran === "verified" ? (
                  <Badge className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 text-lg md:text-xl rounded-2xl gap-2 shadow-lg shadow-green-500/20">
                    <CheckCircle2 size={24} /> TERVERIFIKASI
                  </Badge>
                ) : (
                  <div className="flex flex-col items-center gap-2">
                    <Badge className="bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 text-lg md:text-xl rounded-2xl gap-2 shadow-lg shadow-yellow-500/20">
                      <XCircle size={24} /> MENUNGGU VERIFIKASI
                    </Badge>
                    <p className="text-xs text-center text-teal-900/70 max-w-xs font-medium">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="bg-white/40 p-5 rounded-2xl border border-white/30 text-center hover:bg-white/50 transition-colors">
                    ...
                    <p className="font-bold text-teal-900 text-base md:text-lg leading-tight">{data.asal_sekolah}</p>
                 </div>
                 <div className="bg-white/40 p-5 rounded-2xl border border-white/30 text-center hover:bg-white/50 transition-colors">
                    ...
                    <p className="font-bold text-teal-900 text-base md:text-lg">{data.paket || "SINGLE"}</p>
                 </div>
              </div>
